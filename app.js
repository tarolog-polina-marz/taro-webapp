  ...
  admin_dashboard(s) {
    ...
    const topbarHtml = `<div class="adm-topbar">
      <div class="adm-topbar-left">
        <button class="adm-hamburger" aria-label="Открыть меню" onclick="App.adminToggleSidebar()">☰</button>
      ...
      <div class="adm-modal-backdrop" onclick="App.adminCloseUserDetail()">
        <div class="adm-modal" onclick="event.stopPropagation()">
          <div class="adm-modal-header">
            ...
            <button class="adm-modal-close" aria-label="Закрыть" onclick="App.adminCloseUserDetail()">✕</button>
          </div>
